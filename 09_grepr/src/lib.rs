...
mod tests {
    ...
    fn test_find_lines() {
        ...
        // The patter _or_ should match the one line, "Lorem"
        let re1 = Regex::new("or").unwrap();
        let matches = find_lines(Cursor::new(&text), &re1, false);
        assert!(matches.is_ok());
        assert_eq!(matches.unwrap().len(), 1);

        // When inverted, the function should match the other two line
    ...
    fn test_find_files() {
        ...
        // Verify the function resources to find four lines tbe directory
        ...
        // Verify that the functions returns the bad file as an error
